...
// Obtener datos del médico para mostrar en el formulario
...
<head>
    ...
    <title>Editar Datos del Médico</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Editar Datos del Médico</li>
                    </ol>
                    <!-- Formulario de Edición de Datos del Médico -->
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Editar Datos del Médico</h3>
                                </div>
                                <div class="card-body">
                                    <form action="sp_editarMedico.php" method="POST">
                                        <input type="hidden" name="id_medico" value="<?php echo $medico['id_medico']; ?>" />
                                        
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputNombre" name="nombre" type="text" value="<?php echo $medico['nombre']; ?>" required />
                                            <label for="inputNombre">Nombre</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputApellido" name="apellido" type="text" value="<?php echo $medico['apellido']; ?>" required />
                                            <label for="inputApellido">Apellido</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputEmail" name="email" type="email" value="<?php echo $medico['email']; ?>" required />
                                            <label for="inputEmail">Correo Electrónico</label>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputTelefono" name="telefono" type="text" value="<?php echo $medico['telefono']; ?>" required />
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="perfilMed.php">Volver al perfil</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
